...
BOT_NAME = getenv("BOT_NAME" , "˹kavya˼ ♪ [ ᴛᴘʙ ]™")
ASSUSERNAME = getenv("ASSUSERNAME" , "ALPHA")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOG_GROUP_ID = -1002389305159
OWNER_ID = int(getenv("OWNER_ID", 8417510906)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/rockStar378/Kavya_ontop",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://litter.catbox.moe/y1np46.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://litter.catbox.moe/y1np46.jpg")
